...
public class MainWindow {
    ...
    private class SonicFrame extends JFrame {
        ...
        public SonicFrame() {
            updateFrameTitle(projectTitle);
            this.setIconImage(SonicIO.loadResourceAsImage("/sonic-candle-icon.png"));
            this.setSize(mFrameDefaultDimension);
            this.setMinimumSize(mFrameDefaultDimension);
            this.setResizable(true);
            //TODO Make a custom exit to make sure all threads/streams are done
            this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        }

        public void updateFrameTitle(String newProjectTitle) {
            projectTitle = newProjectTitle;
            this.setTitle("Sonic Candle: " + projectTitle);
        }
