...
public class PopUpBlockDrawer extends BarDrawer {

	public PopUpBlockDrawer(Graphics2D g, int half, int barWidth) {
	...
	public void drawBar(int height, int x) {
		...
		g.fill3DRect(x - center, half - height, drawBarWidth, drawHeight * 2, true);// draw
																					// up
																					// and
																					// down
