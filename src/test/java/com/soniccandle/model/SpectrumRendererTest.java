...
public class SpectrumRendererTest {
    ...
    @Test
    public void test_total_video_frames_is_calculated_on_start()
            throws Exception {
        SpectrumRenderer s = getSpectrumRendererShunt();
        s.start();
    ...
    @Test
    public void test_check_done_sets_isdone_to_false_when_not_done()
    ...
    @Test
    public void test_rendr_next_frame_increases_current_frame()
            throws Exception {
        SpectrumRenderer s = getSpectrumRendererShunt();
        s.totalVFrames = 100;
        s.renderNextFrame();
